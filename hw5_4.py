...
# Press 'n' for the next image. First image is left camera, second image is right camera, and third image is 3d
...
ptl1 = np.array([-2.77 , -2.48 , 6, 1], dtype=float)
ptl2 = np.array([-0.77 , -2.48 , 6, 1], dtype=float)
ptl3 = np.array([-0.77 , -2.48 , 8, 1], dtype=float)
ptl4 = np.array([-2.77 , -2.48 , 8, 1], dtype=float)
ptl5 = np.array([-2.77 , -4.48 , 6, 1], dtype=float)
ptl6 = np.array([-0.77 , -4.28 , 6, 1], dtype=float)
ptl7 = np.array([-0.77 , -4.28 , 8, 1], dtype=float)
ptl8 = np.array([-2.77 , -4.48 , 8, 1], dtype=float)
ptl9 = np.array([-1.77 , -6.28 , 7, 1], dtype=float)

ptr1 = np.array([-4.77, -4.48, 8, 1], dtype=float)
ptr2 = np.array([-2.77, -4.48, 8, 1], dtype=float)
ptr3 = np.array([-2.77, -4.48, 10, 1], dtype=float)
ptr4 = np.array([-4.77, -4.48, 10, 1], dtype=float)
ptr5 = np.array([-4.77, -6.48, 8, 1], dtype=float)
ptr6 = np.array([-2.77, -6.48, 8, 1], dtype=float)
ptr7 = np.array([-2.77, -6.48, 10, 1], dtype=float)
ptr8 = np.array([-4.77, -6.48, 10, 1], dtype=float)
ptr9 = np.array([-3.77, -6.48, 9, 1], dtype=float)
...
ptl1t = np.array(np.matmul(M, ptl1))
finall1 = np.array(ptl1t/ptl1t[2])

ptl2t = np.array(np.matmul(M, ptl2))
finall2 = np.array(ptl2t/ptl2t[2])

ptl3t = np.array(np.matmul(M, ptl3))
finall3 = np.array(ptl3t/ptl3t[2])

ptl4t = np.array(np.matmul(M, ptl4))
finall4 = np.array(ptl4t/ptl4t[2])

ptl5t = np.array(np.matmul(M, ptl5))
finall5 = np.array(ptl5t/ptl5t[2])

ptl6t = np.array(np.matmul(M, ptl6))
finall6 = np.array(ptl6t/ptl6t[2])

ptl7t = np.array(np.matmul(M, ptl7))
finall7 = np.array(ptl7t/ptl7t[2])

ptl8t = np.array(np.matmul(M, ptl8))
finall8 = np.array(ptl8t/ptl8t[2])

ptl9t = np.array(np.matmul(M, ptl9))
finall9 = np.array(ptl9t/ptl9t[2])

ptr1t = np.array(np.matmul(M, ptr1))
finalr1 = np.array(ptr1t/ptr1t[2])

ptr2t = np.array(np.matmul(M, ptr2))
finalr2 = np.array(ptr2t/ptr2t[2])

ptr3t = np.array(np.matmul(M, ptr3))
finalr3 = np.array(ptr3t/ptr3t[2])

ptr4t = np.array(np.matmul(M, ptr4))
finalr4 = np.array(ptr4t/ptr4t[2])

ptr5t = np.array(np.matmul(M, ptr5))
finalr5 = np.array(ptr5t/ptr5t[2])

ptr6t = np.array(np.matmul(M, ptr6))
finalr6 = np.array(ptr6t/ptr6t[2])

ptr7t = np.array(np.matmul(M, ptr7))
finalr7 = np.array(ptr7t/ptr7t[2])

ptr8t = np.array(np.matmul(M, ptr8))
finalr8 = np.array(ptr8t/ptr8t[2])

ptr9t = np.array(np.matmul(M, ptr9))
...
threeD = cv2.triangulatePoints(P1[:3], M[:3], ptl[:2], ptr[:2])
threeD /= threeD[3]
